...
getAllData(`users/${id}` , (res) => {
    getAllData(`users/${id}/posts`, (blog) => {
        getAllData(`users/${id}/albums`, (album) => {
            getAllData(`users/${id}/todos`, (todo) => {
                ...
                <div data-slot="card"
                                                            ...
                                                            <div data-slot="card-header"
                                                                ...
                                                                <div class="flex flex-col items-center gap-4"><span data-slot="avatar"
                                                                    ...
                                                                    <div>
                                                                        <h4 data-slot="card-title" class="leading-none text-gray-900">${res.name}
                                                                            </h4>
                                                                        <p class="text-gray-500">@${res.username}</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div data-slot="card-content" class="px-6 [&amp;:last-child]:pb-6 pt-6 space-y-4">
                                                                <div class="grid grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
                                                                    <div class="text-center">
                                                                        <p class="text-gray-900">${blog.length}</p>
                                                                        <p class="text-gray-500">Posts</p>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <p class="text-gray-900">${album.length}</p>
                                                                        <p class="text-gray-500">Albums</p>
                                                                    </div>
                                                                    <div class="text-center">
                                                                        <p class="text-gray-900">${todo.length}</p>
                                                                ...
                                                                <div class="space-y-3">
                                                                    <div class="flex items-center gap-3 text-gray-600"><svg
                                                                        ...
                                                                        </svg><span class="truncate">${res.email}</span></div>
                                                                    <div class="flex items-center gap-3 text-gray-600"><svg
                                                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                                            viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                                    ...
                                                                    <div class="flex items-center gap-3 text-gray-600"><svg
                                                                        ...
                                                                        </svg><span class="truncate">${res.address.city}</span></div>
                                                                </div>
